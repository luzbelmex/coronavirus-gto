...
var lineaContagiados = new Chart( contagiados, {
    type: 'line',
    data: {
      labels: ['15-Marzo','16-Marzo', '17-Marzo', '18-Marzo', '19-Marzo', '20-Marzo', '21-Marzo', '22-Marzo', '23-Marzo', '24-Marzo', '25-Marzo', '26-Marzo', '27-Marzo', '28-Marzo', '29-Marzo', '30-Marzo', '31-Marzo', '1-Abril', '2-Abril', '3-Abril', '4-Abril', '5-Abril', '6-Abril', '7-Abril', '8-Abril', '9-Abril', '10-Abril', '11-Abril'],
      datasets: [{
        label: 'Contagiados',
        data: [0, 1, 1, 4, 4, 4, 4, 7, 9, 13, 25, 31, 31, 37, 37, 43, 46, 49, 50, 52, 54, 54, 58, 62, 73, 78, 88, 92 ],
      ...
      {
        label: 'Recuperados',
        data: [, , , , , , , , , , , , , , , , 0, 16, 16, 16, 17, 17, 17, 17, 19, 21, 28, 28 ],
...
var lineaCiudades = new Chart( ciudades, {
  ...
  data: {
    ...
    datasets: [{
      label: 'Contagiados',
      data: [2, 6, 1, 7, 9, 33, 1, 26, 1, 3, 1, 1, 1],
    ...
    {
      label: 'Recuperados',
      data: [0, 0, 0,  1, 2, 21, 0, 1, 1, 0, 1, 1, 0],
    ...
    {
      label: 'Sospechosos',
      data: [1, 38, 1, 5, 10, 101, 2, 9, 1, 3, 5, 3, 1],
      backgroundColor: 'rgba(255, 205, 43, 0.5)',
      borderColor: 'rgb(255, 205, 43)',
    },
    {
      label: 'Fallecidos',
      data: [0, 1, 0, 1, 0, 0, 0, 3, 0, 0, 0, 0],
